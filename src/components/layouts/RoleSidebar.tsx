...
const roleMenus: Record<AppRole, MenuItem[]> = {
  ...
  master: [
    ...
    { icon: Scale, label: 'Legal Manager', path: '/super-admin-system/role-switch?role=legal_manager' },
    { icon: ListTodo, label: 'Task Manager', path: '/super-admin-system/role-switch?role=task_management' },
