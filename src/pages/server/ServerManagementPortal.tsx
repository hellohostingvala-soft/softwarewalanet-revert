...
import { 
  ...
  Database, Cloud, Lock, Eye, EyeOff, Save
} from 'lucide-react';
  ...
  const handleSaveServer = () => {
    ...
    setTimeout(() => {
      setServerConfig(prev => ({
        ...prev,
        name: newServer.name || 'Demo Server',
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-8">
          <div>
            ...
            <p className="text-slate-400 mt-1">Manage your demo hosting server</p>
          </div>
            ...
            <DialogContent className="bg-slate-900 border-slate-700 text-white">
              <DialogHeader>
                ...
                <DialogDescription className="text-slate-400">
                  Enter your server details to host demos
                </DialogDescription>
              </DialogHeader>
              ...
              <div className="space-y-4 pt-4">
                <div>
                  ...
                  <Input
                    id="server-name"
                    placeholder="Primary Demo Server"
              ...
              <div className="flex items-center gap-4 flex-1">
                ...
                <div>
                  <div className="flex items-center gap-3">
                    <h2 className="text-xl font-bold">{serverConfig.name}</h2>
                    {getStatusBadge(serverConfig.status)}
                  </div>
                  <div className="flex items-center gap-2 mt-1 text-slate-400 text-sm">
                    <Globe className="w-4 h-4" />
                    <span>{serverConfig.ip_address || 'Not configured'}</span>
                    {serverConfig.ip_address && (
                      <button onClick={() => copyToClipboard(serverConfig.ip_address)} className="hover:text-white">
          ...
          <TabsContent value="overview" className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <Card className="bg-slate-900/50 border-slate-800">
                ...
                <CardContent>
                  <div className="text-3xl font-bold mb-2">{serverConfig.cpu_usage}%</div>
                  <Progress value={serverConfig.cpu_usage} className="h-2" />
              ...
              <Card className="bg-slate-900/50 border-slate-800">
                ...
                <CardContent>
                  <div className="text-3xl font-bold mb-2">{serverConfig.ram_usage}%</div>
                  <Progress value={serverConfig.ram_usage} className="h-2" />
              ...
              <Card className="bg-slate-900/50 border-slate-800">
                ...
                <CardContent>
                  <div className="text-3xl font-bold mb-2">{serverConfig.disk_usage}%</div>
                  <Progress value={serverConfig.disk_usage} className="h-2" />
              ...
              <CardHeader className="flex flex-row items-center justify-between">
                <div>
                  ...
                  <CardDescription className="text-slate-400">
                    All demos running on your server
                  </CardDescription>
                </div>
                  ...
                  <div className="bg-slate-900/50 p-3 rounded-lg">
                    ...
                    <div className="flex items-center gap-2">
                      <code className="text-sm bg-slate-800 px-3 py-1.5 rounded flex-1">
                        A Record → {serverConfig.ip_address || 'Your Server IP'}
                      </code>
                      <Button variant="ghost" size="icon" onClick={() => copyToClipboard(serverConfig.ip_address)}>
              ...
              <Card className="bg-slate-900/50 border-slate-800">
                ...
                <CardContent className="space-y-4">
                  {[
                    ...
                    { label: 'SSL Certificate', status: 'active', icon: Lock },
                    { label: 'DDoS Protection', status: 'active', icon: Zap },
                    { label: 'Fail2Ban', status: 'active', icon: Activity },
                  ].map((item) => (
              ...
              <Card className="bg-slate-900/50 border-slate-800">
                ...
                <CardContent className="space-y-4">
                  <div className="p-4 rounded-lg bg-slate-800/50">
                    ...
                    <div className="flex items-center justify-between mb-2">
                      <span className="text-sm text-slate-400">Next Backup</span>
                      <span className="font-medium">In 4 hours</span>
                    </div>
                    <div className="flex items-center justify-between">
                      <span className="text-sm text-slate-400">Total Backups</span>
