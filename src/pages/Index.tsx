...
import { 
  ...
  Sparkles, School, FlaskConical, Droplet, Glasses, Wrench, Wind, Zap, CarFront,
  ParkingCircle, Film, Sun, Umbrella, TrendingUp, Flower2, Brush, Stethoscope,
  Waves, Pizza, Coffee, Flower, Bug, ChefHat, IceCream, Sword, Gamepad2,
  Ticket, Tent, Fish, Landmark, Frame, Clock
} from "lucide-react";
...
const allDemos: Demo[] = [
  ...
  // ============= MORE COMING SOON DEMOS (20 More - Total 60) =============
  {
    id: "astrology",
    name: "Astrology & Horoscope",
    category: "Astrology",
    description: "Astrology platform with horoscope generation, kundli matching, and consultation booking.",
    url: "#",
    icon: Sparkles,
    status: "COMING_SOON",
    features: ["Horoscope", "Kundli Match", "Consultation", "Panchang"],
    frontend: ["React", "TypeScript", "Vedic UI"],
    backend: ["Node.js", "PostgreSQL", "Astro API"],
  ...
  {
    id: "tuition",
    name: "Tuition Center System",
    category: "Tuition",
    description: "Tuition center management with batch scheduling, student tracking, and fee collection.",
    url: "#",
    icon: School,
    status: "COMING_SOON",
    features: ["Batch Schedule", "Student Tracking", "Fee Collection", "Parent App"],
  ...
  },
  {
    ...
    category: "Coaching",
    description: "Coaching center management with test series, video lectures, and performance analytics.",
    url: "#",
    icon: GraduationCap,
    status: "COMING_SOON",
    features: ["Test Series", "Video Lectures", "Analytics", "Doubt Solving"],
    frontend: ["React", "TypeScript", "LMS UI"],
    backend: ["Node.js", "PostgreSQL", "Video CDN"],
  ...
  {
    id: "diagnostic",
    name: "Diagnostic Lab System",
    category: "Diagnostic",
    description: "Pathology lab management with test booking, sample collection, and report delivery.",
    url: "#",
    icon: FlaskConical,
    status: "COMING_SOON",
    features: ["Test Booking", "Sample Collection", "Reports", "Home Collection"],
    frontend: ["React", "TypeScript", "Lab UI"],
    backend: ["Node.js", "PostgreSQL", "LIMS API"],
  ...
  },
  {
    ...
    category: "Blood Bank",
    description: "Blood bank management with donor database, inventory, and request management.",
    url: "#",
    icon: Droplet,
    status: "COMING_SOON",
    features: ["Donor Database", "Blood Inventory", "Request Mgmt", "Camp Organize"],
    frontend: ["React", "TypeScript", "Medical UI"],
    backend: ["Node.js", "PostgreSQL", "SMS Alerts"],
    color: "from-red-600 to-rose-600",
    price: "₹49,999",
    discountPrice: "₹29,999"
  },
  {
    id: "optical",
    name: "Optical Store System",
    category: "Optical",
    description: "Optical shop management with prescription records, lens inventory, and frame catalog.",
    url: "#",
    icon: Glasses,
    status: "COMING_SOON",
    features: ["Prescription Records", "Lens Inventory", "Frame Catalog", "Order Track"],
    frontend: ["React", "TypeScript", "Retail UI"],
    backend: ["Node.js", "PostgreSQL", "POS API"],
    color: "from-sky-600 to-blue-600",
    price: "₹39,999",
    discountPrice: "₹23,999"
  },
  {
    ...
    description: "Mobile repair shop management with job cards, spare parts, and warranty tracking.",
    url: "#",
    icon: Wrench,
    status: "COMING_SOON",
    features: ["Job Cards", "Spare Parts", "Warranty Track", "Customer SMS"],
    frontend: ["React", "TypeScript", "Service UI"],
    backend: ["Node.js", "PostgreSQL", "Parts API"],
    color: "from-gray-600 to-slate-600",
    price: "₹34,999",
    discountPrice: "₹20,999"
  },
  {
    ...
    category: "AC Service",
    description: "AC service management with technician scheduling, AMC contracts, and complaint tracking.",
    url: "#",
    icon: Wind,
    status: "COMING_SOON",
    features: ["Technician Schedule", "AMC Contracts", "Complaint Track", "Spare Mgmt"],
    frontend: ["React", "TypeScript", "Service UI"],
    backend: ["Node.js", "PostgreSQL", "Field API"],
  ...
  },
  {
    ...
    category: "Electrical",
    description: "Electrical contractor management with project estimation, material tracking, and billing.",
    url: "#",
    icon: Zap,
    status: "COMING_SOON",
    features: ["Project Estimation", "Material Track", "Billing", "Worker Mgmt"],
    frontend: ["React", "TypeScript", "Field UI"],
    backend: ["Node.js", "PostgreSQL", "Job API"],
  ...
  },
  {
    ...
    category: "Car Wash",
    description: "Car wash management with booking, membership packages, and queue management.",
    url: "#",
    icon: CarFront,
    status: "COMING_SOON",
    features: ["Online Booking", "Memberships", "Queue Mgmt", "Package Plans"],
    frontend: ["React", "TypeScript", "Booking UI"],
  ...
  },
  {
    ...
    category: "Parking",
    description: "Parking lot management with slot booking, ANPR integration, and monthly passes.",
    url: "#",
    icon: ParkingCircle,
    status: "COMING_SOON",
    features: ["Slot Booking", "ANPR", "Monthly Pass", "Revenue Reports"],
    frontend: ["React", "TypeScript", "Parking UI"],
    backend: ["Node.js", "PostgreSQL", "ANPR API"],
    color: "from-slate-600 to-gray-600",
    price: "₹49,999",
    discountPrice: "₹29,999"
  },
  {
    id: "cinema",
    name: "Cinema & Theater System",
    category: "Cinema",
    description: "Movie theater management with show scheduling, seat booking, and concession sales.",
    url: "#",
    icon: Film,
    status: "COMING_SOON",
    features: ["Show Schedule", "Seat Booking", "Concession POS", "Membership"],
    frontend: ["React", "TypeScript", "Cinema UI"],
    backend: ["Node.js", "PostgreSQL", "Payment API"],
    color: "from-red-600 to-orange-600",
    price: "₹69,999",
    discountPrice: "₹41,999"
  },
  {
    ...
    category: "Solar",
    description: "Solar installation management with site survey, installation tracking, and AMC.",
    url: "#",
    icon: Sun,
    status: "COMING_SOON",
    features: ["Site Survey", "Installation Track", "AMC Mgmt", "Generation Monitor"],
    frontend: ["React", "TypeScript", "Energy UI"],
    backend: ["Node.js", "PostgreSQL", "IoT API"],
  ...
  {
    id: "insurance",
    name: "Insurance Agency System",
    category: "Insurance",
    description: "Insurance agency management with policy tracking, claims, and commission management.",
    url: "#",
    icon: Umbrella,
    status: "COMING_SOON",
    features: ["Policy Tracking", "Claims Mgmt", "Commission", "Renewals"],
    frontend: ["React", "TypeScript", "Finance UI"],
    backend: ["Node.js", "PostgreSQL", "Insurance API"],
    color: "from-blue-600 to-violet-600",
    price: "₹64,999",
    discountPrice: "₹38,999"
  },
  {
    ...
    description: "Stock trading platform with portfolio management, market analysis, and alerts.",
    url: "#",
    icon: TrendingUp,
    status: "COMING_SOON",
    features: ["Portfolio Mgmt", "Market Analysis", "Alerts", "P&L Reports"],
  ...
  {
    id: "yoga",
    name: "Yoga Studio System",
    category: "Yoga",
    description: "Yoga studio management with class scheduling, instructor management, and memberships.",
    url: "#",
    icon: Flower2,
    status: "COMING_SOON",
    features: ["Class Schedule", "Instructor Mgmt", "Memberships", "Video Library"],
  ...
  {
    id: "tattoo",
    name: "Tattoo Studio System",
    category: "Tattoo",
    description: "Tattoo studio management with appointment booking, design gallery, and artist portfolio.",
    url: "#",
    icon: Brush,
    status: "COMING_SOON",
    features: ["Appointments", "Design Gallery", "Artist Portfolio", "Aftercare"],
    frontend: ["React", "TypeScript", "Art UI"],
    backend: ["Node.js", "PostgreSQL", "Gallery API"],
  ...
  {
    id: "clinic",
    name: "Doctor Clinic System",
    category: "Clinic",
    description: "Clinic management with patient records, appointments, prescriptions, and billing.",
    url: "#",
    icon: Stethoscope,
    status: "COMING_SOON",
    features: ["Patient Records", "Appointments", "E-Prescription", "Billing"],
    frontend: ["React", "TypeScript", "Medical UI"],
    backend: ["Node.js", "PostgreSQL", "EMR API"],
  ...
  {
    id: "aquarium",
    name: "Aquarium & Fish Store",
    category: "Aquarium",
    description: "Aquarium shop management with fish inventory, tank maintenance, and accessories.",
    url: "#",
    icon: Waves,
    status: "COMING_SOON",
    features: ["Fish Inventory", "Tank Maintenance", "Accessories", "Care Tips"],
    frontend: ["React", "TypeScript", "Pet UI"],
    backend: ["Node.js", "PostgreSQL", "Stock API"],
  ...
  },
  {
    ...
    category: "Pizzeria",
    description: "Pizza shop management with online ordering, kitchen display, and delivery tracking.",
    url: "#",
    icon: Pizza,
    status: "COMING_SOON",
    features: ["Online Ordering", "Kitchen Display", "Delivery Track", "Loyalty Program"],
    frontend: ["React", "TypeScript", "Food UI"],
    backend: ["Node.js", "PostgreSQL", "Delivery API"],
  ...
  },
  {
    ...
    description: "Cafe management with POS, loyalty cards, inventory, and shift management.",
    url: "#",
    icon: Coffee,
    status: "COMING_SOON",
    features: ["POS Billing", "Loyalty Cards", "Inventory", "Shift Mgmt"],
    frontend: ["React", "TypeScript", "Cafe UI"],
    backend: ["Node.js", "PostgreSQL", "Payment API"],
    color: "from-amber-700 to-yellow-700",
    price: "₹34,999",
    discountPrice: "₹20,999"
  },
  // ============= EVEN MORE COMING SOON DEMOS (20 More - Total 80) =============
  {
    id: "florist",
    name: "Florist & Flower Shop",
    category: "Florist",
    description: "Flower shop management with bouquet ordering, delivery scheduling, and event decorations.",
    url: "#",
    icon: Flower,
    status: "COMING_SOON",
    features: ["Bouquet Orders", "Delivery Schedule", "Event Decor", "Subscription"],
    frontend: ["React", "TypeScript", "Floral UI"],
    backend: ["Node.js", "PostgreSQL", "Delivery API"],
  ...
  },
  {
    ...
    description: "Pest control management with service scheduling, chemical inventory, and AMC tracking.",
    url: "#",
    icon: Bug,
    status: "COMING_SOON",
    features: ["Service Schedule", "Chemical Inventory", "AMC Tracking", "Reports"],
    frontend: ["React", "TypeScript", "Service UI"],
    backend: ["Node.js", "PostgreSQL", "Field API"],
  ...
  {
    id: "catering",
    name: "Catering Service System",
    category: "Catering",
    description: "Catering business management with menu planning, event booking, and staff coordination.",
    url: "#",
    icon: ChefHat,
    status: "COMING_SOON",
    features: ["Menu Planning", "Event Booking", "Staff Mgmt", "Billing"],
    frontend: ["React", "TypeScript", "Food UI"],
    backend: ["Node.js", "PostgreSQL", "Event API"],
    color: "from-orange-600 to-red-600",
    price: "₹49,999",
    discountPrice: "₹29,999"
  },
  {
    ...
    category: "Ice Cream",
    description: "Ice cream shop management with flavor inventory, POS, and loyalty programs.",
    url: "#",
    icon: IceCream,
    status: "COMING_SOON",
    features: ["Flavor Inventory", "POS Billing", "Loyalty Cards", "Toppings Mgmt"],
    frontend: ["React", "TypeScript", "Sweet UI"],
    backend: ["Node.js", "PostgreSQL", "POS API"],
    color: "from-pink-400 to-purple-400",
    price: "₹24,999",
  ...
  },
  {
    ...
    description: "Martial arts school management with belt grading, class scheduling, and tournament tracking.",
    url: "#",
    icon: Sword,
    status: "COMING_SOON",
    features: ["Belt Grading", "Class Schedule", "Tournament", "Student Progress"],
    frontend: ["React", "TypeScript", "Sports UI"],
    backend: ["Node.js", "PostgreSQL", "Grading API"],
  ...
  },
  {
    ...
    category: "Gaming",
    description: "Gaming arcade management with time-based billing, membership, and tournament hosting.",
    url: "#",
    icon: Gamepad2,
    status: "COMING_SOON",
    features: ["Time Billing", "Memberships", "Tournaments", "Snack Bar"],
    frontend: ["React", "TypeScript", "Gaming UI"],
    backend: ["Node.js", "PostgreSQL", "Timer API"],
    color: "from-purple-600 to-indigo-600",
    price: "₹44,999",
    discountPrice: "₹26,999"
  },
  {
    id: "escaperoom",
    name: "Escape Room Booking",
    category: "Escape Room",
    description: "Escape room management with room booking, theme management, and group scheduling.",
    url: "#",
    icon: Ticket,
    status: "COMING_SOON",
    features: ["Room Booking", "Theme Mgmt", "Group Schedule", "Leaderboard"],
    frontend: ["React", "TypeScript", "Adventure UI"],
  ...
  {
    id: "waterpark",
    name: "Water Park System",
    category: "Water Park",
    description: "Water park management with ticket booking, locker management, and safety tracking.",
    url: "#",
    icon: Waves,
    status: "COMING_SOON",
    features: ["Ticket Booking", "Locker Mgmt", "Safety Track", "Food Court"],
    frontend: ["React", "TypeScript", "Park UI"],
    backend: ["Node.js", "PostgreSQL", "Ticketing API"],
    color: "from-blue-500 to-cyan-500",
    price: "₹79,999",
    discountPrice: "₹47,999"
  },
  {
    id: "amusement",
    name: "Amusement Park System",
    category: "Amusement Park",
    description: "Amusement park management with ride booking, fast pass, and crowd management.",
    url: "#",
    icon: Tent,
    status: "COMING_SOON",
    features: ["Ride Booking", "Fast Pass", "Crowd Mgmt", "Revenue Track"],
    frontend: ["React", "TypeScript", "Park UI"],
    backend: ["Node.js", "PostgreSQL", "Queue API"],
    color: "from-yellow-500 to-orange-500",
    price: "₹99,999",
    discountPrice: "₹59,999"
  },
  {
    ...
    category: "Zoo",
    description: "Zoo management with animal records, feeding schedules, and visitor management.",
    url: "#",
    icon: Fish,
    status: "COMING_SOON",
    features: ["Animal Records", "Feeding Schedule", "Visitor Mgmt", "Conservation"],
    frontend: ["React", "TypeScript", "Wildlife UI"],
    backend: ["Node.js", "PostgreSQL", "Animal API"],
    color: "from-green-600 to-teal-600",
    price: "₹89,999",
    discountPrice: "₹53,999"
  },
  {
    ...
    category: "Museum",
    description: "Museum management with exhibit tracking, ticket booking, and audio guide system.",
    url: "#",
    icon: Landmark,
    status: "COMING_SOON",
    features: ["Exhibit Track", "Ticket Booking", "Audio Guide", "Event Mgmt"],
    frontend: ["React", "TypeScript", "Cultural UI"],
    backend: ["Node.js", "PostgreSQL", "Guide API"],
  ...
  {
    id: "artgallery",
    name: "Art Gallery System",
    category: "Art Gallery",
    description: "Art gallery management with artwork catalog, auction system, and artist management.",
    url: "#",
    icon: Frame,
    status: "COMING_SOON",
    features: ["Artwork Catalog", "Auction System", "Artist Mgmt", "Exhibition"],
    frontend: ["React", "TypeScript", "Art UI"],
    backend: ["Node.js", "PostgreSQL", "Auction API"],
    color: "from-purple-600 to-pink-600",
    price: "₹54,999",
    discountPrice: "₹32,999"
  },
  {
    id: "antique",
    name: "Antique Store System",
    category: "Antique",
    description: "Antique shop management with item cataloging, valuation tracking, and authentication.",
    url: "#",
    icon: Clock,
    status: "COMING_SOON",
    features: ["Item Catalog", "Valuation", "Authentication", "Auction"],
    frontend: ["React", "TypeScript", "Vintage UI"],
    backend: ["Node.js", "PostgreSQL", "Valuation API"],
    color: "from-amber-700 to-yellow-700",
    price: "₹44,999",
    discountPrice: "₹26,999"
  },
  {
    ...
    description: "Dry cleaning management with garment tracking, pricing, and delivery scheduling.",
    url: "#",
    icon: Shirt,
    status: "COMING_SOON",
    features: ["Garment Track", "Pricing Mgmt", "Delivery", "Customer Portal"],
    frontend: ["React", "TypeScript", "Service UI"],
    backend: ["Node.js", "PostgreSQL", "Tracking API"],
    color: "from-blue-600 to-indigo-600",
    price: "₹29,999",
    discountPrice: "₹17,999"
  },
  {
    id: "foodtruck",
    name: "Food Truck System",
    category: "Food Truck",
    description: "Food truck management with location tracking, menu management, and mobile POS.",
    url: "#",
    icon: Truck,
    status: "COMING_SOON",
    features: ["Location Track", "Menu Mgmt", "Mobile POS", "Order Queue"],
  ...
  {
    id: "swimming",
    name: "Swimming Pool System",
    category: "Swimming",
    description: "Swimming pool management with membership, class booking, and maintenance tracking.",
    url: "#",
    icon: Waves,
    status: "COMING_SOON",
    features: ["Memberships", "Class Booking", "Maintenance", "Coach Assign"],
    frontend: ["React", "TypeScript", "Aqua UI"],
    backend: ["Node.js", "PostgreSQL", "Booking API"],
    color: "from-cyan-500 to-blue-500",
    price: "₹44,999",
    discountPrice: "₹26,999"
  ...
  {
    id: "bowling",
    name: "Bowling Alley System",
    category: "Bowling",
    description: "Bowling alley management with lane booking, scoring, and tournament hosting.",
    url: "#",
    icon: Trophy,
    status: "COMING_SOON",
    features: ["Lane Booking", "Auto Scoring", "Tournaments", "Shoe Rental"],
    frontend: ["React", "TypeScript", "Sports UI"],
    backend: ["Node.js", "PostgreSQL", "Scoring API"],
    color: "from-red-600 to-orange-600",
    price: "₹54,999",
    discountPrice: "₹32,999"
  },
  {
    id: "trampoline",
    name: "Trampoline Park System",
    category: "Trampoline",
    description: "Trampoline park management with time-based entry, waiver management, and party booking.",
    url: "#",
    icon: Tent,
    status: "COMING_SOON",
    features: ["Time Entry", "Waiver Mgmt", "Party Booking", "Safety Track"],
    frontend: ["React", "TypeScript", "Fun UI"],
    backend: ["Node.js", "PostgreSQL", "Entry API"],
  ...
  {
    id: "gokart",
    name: "Go-Kart Racing System",
    category: "Go-Kart",
    description: "Go-kart track management with lap timing, race booking, and championship tracking.",
    url: "#",
    icon: CarFront,
    status: "COMING_SOON",
    features: ["Lap Timing", "Race Booking", "Championship", "Safety Gear"],
    frontend: ["React", "TypeScript", "Racing UI"],
    backend: ["Node.js", "PostgreSQL", "Timing API"],
...
const categories = [
  ...
  "DevOps, Developer & IT Operations",
  "AI, Automation & Machine Learning",
  "Data Analytics, BI & Reporting",
  "Project, Task & Workflow Management",
  "Society, Community & Association Management",
  "Construction & Engineering Management",
  "Energy, Utilities & Smart Systems",
  "IoT, Smart Devices & Automation",
  "Media, Entertainment & Streaming",
  "Event, Ticketing & Booking Systems",
  "Fitness, Wellness & Lifestyle",
  "Insurance & Risk Management",
  "Franchise, Reseller & Partner Management",
  "Agriculture & Farm Management",
  "NGO, Charity & Donation Management",
  "Travel, Tourism & Visa Management",
  "Recruitment & Staffing Systems",
