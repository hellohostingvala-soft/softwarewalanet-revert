...
const categories = [
  ...
  "Sports Academy", "Music Academy", "Dance Academy", "Astrology", "Tuition",
  "Coaching", "Diagnostic", "Blood Bank", "Optical", "Mobile Repair", "AC Service",
  "Electrical", "Car Wash", "Parking", "Cinema", "Solar", "Insurance", "Stock Trading",
  "Yoga", "Tattoo", "Clinic", "Aquarium", "Pizzeria", "Coffee Shop"
];
